...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
    <title>หน้าสรุปยอดเบิกเงิน - ระบบเบิกค่ารักษาพยาบาลพนักงานสถาบันฯ (Medical Expense Reimbursement System)</title>
        ...
        <div class="row">
              ...
              <div class="panel-body">
                <ul class="nav nav-pills nav-justified" >
                  ...
                  <li role="presentation" class="active"><a href="/admin/graph">สรุปยอดเบิกเงิน</a></li>
              ...
              <div class="panel-body">
                ...
                <div class="col-lg-10 col-md-10 col-sm-10">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                    <label for="Search" class="col-lg-4 col-md-4 col-sm-4 form-group"><h4>เลือกประเภท : </h4></label>
                  </div>

                  <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                    <label  class="col-lg-1 col-md-1 col-sm-1 form-group"></label>
                    <label  class="col-lg-3 col-md-3 col-sm-3 form-group">
                    <button type="button" class="btn btn-info" style="width:200px" data-toggle="modal" data-target="#graphEmpModal">แบ่งตามประเภทพนักงาน</button>
                    </label>
                    <label  class="col-lg-1 col-md-1 col-sm-1 form-group"></label>
                    <label  class="col-lg-3 col-md-3 col-sm-3 form-group">
                    <button type="button" class="btn btn-info" style="width:200px" data-toggle="modal" data-target="#graphDepModal">แบ่งตามประเภทหน่วยงาน</button>
                    </label>
                  </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <!-- graphEmpModal -->
                      <div class="modal fade" id="graphEmpModal" tabindex="-1" role="dialog" aria-labelledby="graphEmpModalLabel">
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header bg-primary">
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                              <h4 class="modal-title" id="graphEmpModalLabel">สรุปยอดเบิกเงินพนักงาน</h4>
                            </div>
                  ...
                  <!-- graphDepModal -->
                      <div class="modal fade" id="graphDepModal" tabindex="-1" role="dialog" aria-labelledby="graphDepModalLabel">
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header bg-primary">
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                              <h4 class="modal-title" id="graphDepModalLabel">สรุปยอดเบิกเงินหน่วยงาน</h4>
                            </div>
                            <div class="modal-body">
